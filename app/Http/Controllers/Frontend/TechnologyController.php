...
class TechnologyController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.technologies.create', compact('projects'));
    }
    ...
    public function store(StoreTechnologyRequest $request)
    {
        ...
        return redirect()->route('frontend.technologies.index');
    }
    ...
    public function edit(Technology $technology)
    {
        ...
        return view('frontend.technologies.edit', compact('projects', 'technology'));
    }
    ...
    public function show(Technology $technology)
    {
        ...
        return view('frontend.technologies.show', compact('technology'));
    }
