    ...
    public function run()
    {
        ...
        \DB::table('projects')->insert(array (
            ...
            array (
                ...
                'solutions' => '<ul><li>Built a custom SaaS subscription system.</li><li>Build admin manager site fully responsive so can be used and managed by mobile.</li><li>Added new standards to blog post for SEO and Schema</li></ul>',
                'meta_title' => NULL,
                ...
                'updated_at' => '2022-01-11 21:38:08',
                'deleted_at' => NULL,
                'category_id' => NULL,
                'client_id' => NULL,
            ),
