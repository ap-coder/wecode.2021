    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-categoryProjects">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($projects as $key => $project)
                            <tr data-entry-id="{{ $project->id }}">
                                ...
                                <td>
                                    <span style="display:none">{{ $project->published ?? '' }}</span>
...
@endcan
  ...
  let table = $('.datatable-categoryProjects:not(.ajaxTable)').DataTable({ buttons: dtButtons })
