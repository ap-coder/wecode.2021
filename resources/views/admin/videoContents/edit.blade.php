...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.video-contents.update", [$videoContent->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <div class="form-check {{ $errors->has('published') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="published" value="0">
                    <input class="form-check-input" type="checkbox" name="published" id="published" value="1" {{ $videoContent->published || old('published', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('public_everywhere') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="public_everywhere" id="public_everywhere" value="1" {{ $videoContent->public_everywhere || old('public_everywhere', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $videoContent->title) }}" required>
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('alternate_title') ? 'is-invalid' : '' }}" type="text" name="alternate_title" id="alternate_title" value="{{ old('alternate_title', $videoContent->alternate_title) }}">
            ...
            <div class="form-group">
                ...
                {{-- <textarea class="form-control ckeditor {{ $errors->has('content_area') ? 'is-invalid' : '' }}" name="content_area" id="content_area">{!! old('content_area', $videoContent->content_area) !!}</textarea> --}}
                <textarea rows="20" autocomplete="off" name="content_area" class="articleeditor-content {{ $errors->has('content_area') ? 'is-invalid' : '' }}" id="content_area">{!! old('content_area', @$videoContent->content_area) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('youtube') ? 'is-invalid' : '' }}" type="text" name="youtube" id="youtube" value="{{ old('youtube', $videoContent->youtube) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vimeo') ? 'is-invalid' : '' }}" type="text" name="vimeo" id="vimeo" value="{{ old('vimeo', $videoContent->vimeo) }}">
                @if($errors->has('vimeo'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_video') ? 'is-invalid' : '' }}" type="text" name="other_video" id="other_video" value="{{ old('other_video', $videoContent->other_video) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('meta_title') ? 'is-invalid' : '' }}" type="text" name="meta_title" id="meta_title" value="{{ old('meta_title', $videoContent->meta_title) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('meta_description') ? 'is-invalid' : '' }}" type="text" name="meta_description" id="meta_description" value="{{ old('meta_description', $videoContent->meta_description) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fbt') ? 'is-invalid' : '' }}" type="text" name="fbt" id="fbt" value="{{ old('fbt', $videoContent->fbt) }}">
                @if($errors->has('fbt'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fbd') ? 'is-invalid' : '' }}" type="text" name="fbd" id="fbd" value="{{ old('fbd', $videoContent->fbd) }}">
                @if($errors->has('fbd'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('twt') ? 'is-invalid' : '' }}" type="text" name="twt" id="twt" value="{{ old('twt', $videoContent->twt) }}">
                @if($errors->has('twt'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('twd') ? 'is-invalid' : '' }}" type="text" name="twd" id="twd" value="{{ old('twd', $videoContent->twd) }}">
                @if($errors->has('twd'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('notes_area') ? 'is-invalid' : '' }}" name="notes_area" id="notes_area">{{ old('notes_area', $videoContent->notes_area) }}</textarea>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\VideoContent::VIDEO_TYPE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('video_type') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="video_type_{{ $key }}" name="video_type" value="{{ $key }}" {{ old('video_type', $videoContent->video_type) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="featuredimage">
                <input class="form-control" data-toggle="fileupload" data-size="thumbnail" data-button="{{ trans('cruds.videoContent.fields.placeholder') }}" data-src="false" data-srcid="{{ @get_attachment_url(@$videoContent->placeholder) }}" data-field="placeholder" type="hidden" name="placeholder" value="{{ @$videoContent->placeholder }}" >
            </div>
            {{-- <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('order') ? 'is-invalid' : '' }}" type="number" name="order" id="order" value="{{ old('order', $videoContent->order) }}" step="1">
                @if($errors->has('order'))
