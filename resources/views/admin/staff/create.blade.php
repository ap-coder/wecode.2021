    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.staff.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('short_intro') ? 'is-invalid' : '' }}" name="short_intro" id="short_intro">{{ old('short_intro') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea rows="20" autocomplete="off" name="bio" class="articleeditor-content {{ $errors->has('bio') ? 'is-invalid' : '' }}" id="bio">{!! old('bio') !!}</textarea>
                @if($errors->has('bio'))
            ...
            <div class="featuredimage">
                <input class="form-control" data-toggle="fileupload" data-size="thumbnail" data-button="{{ trans('cruds.staff.fields.picture') }}" data-src="false" data-srcid="" data-field="picture" type="hidden" name="picture">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('staff_email') ? 'is-invalid' : '' }}" type="email" name="staff_email" id="staff_email" value="{{ old('staff_email') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gravatar') ? 'is-invalid' : '' }}" type="email" name="gravatar" id="gravatar" value="{{ old('gravatar') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('in_teams') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="in_teams" id="in_teams" value="1" {{ old('in_teams', 0) == 1 || old('in_teams') === null ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('list_on_about') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="list_on_about" id="list_on_about" value="1" {{ old('list_on_about', 0) == 1 ? 'checked' : '' }}>
