                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.services.update", [$service->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sub_title" id="sub_title" value="{{ old('sub_title', $service->sub_title) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="service_text" id="service_text">{!! old('service_text', $service->service_text) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="service_text_2" id="service_text_2">{!! old('service_text_2', $service->service_text_2) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="excerpt" id="excerpt">{{ old('excerpt', $service->excerpt) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="meta_title" id="meta_title" value="{{ old('meta_title', $service->meta_title) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="meta_description" id="meta_description" value="{{ old('meta_description', $service->meta_description) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="facebook_title" id="facebook_title" value="{{ old('facebook_title', $service->facebook_title) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="facebook_desc" id="facebook_desc" value="{{ old('facebook_desc', $service->facebook_desc) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="published" id="published" value="1" {{ $service->published || old('published', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="slug" id="slug" value="{{ old('slug', $service->slug) }}">
                            @if($errors->has('slug'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('slug') }}
                                </div>
