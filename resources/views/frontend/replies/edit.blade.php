                    ...
                    <form method="POST" action="{{ route("frontend.replies.update", [$reply->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="published" id="published" value="1" {{ $reply->published || old('published', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="private" id="private" value="1" {{ $reply->private || old('private', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="best_answer" id="best_answer" value="1" {{ $reply->best_answer || old('best_answer', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="content_area" id="content_area">{!! old('content_area', $reply->content_area) !!}</textarea>
