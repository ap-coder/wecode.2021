                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.posts.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="body_text" id="body_text">{!! old('body_text') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contributor" id="contributor" value="{{ old('contributor', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contributor_link" id="contributor_link" value="{{ old('contributor_link', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contributor_2" id="contributor_2" value="{{ old('contributor_2', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contributor_2_link" id="contributor_2_link" value="{{ old('contributor_2_link', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="menu_order" id="menu_order" value="{{ old('menu_order', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="comment_count" id="comment_count" value="{{ old('comment_count', '0') }}" step="1">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="ping_status" id="ping_status" value="1" {{ old('ping_status', 0) == 1 ? 'checked' : '' }}>
