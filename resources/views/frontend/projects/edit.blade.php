                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.projects.update", [$project->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="intro" id="intro">{{ old('intro', $project->intro) }}</textarea>
                            @if($errors->has('intro'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('intro') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="body_content" id="body_content">{!! old('body_content', $project->body_content) !!}</textarea>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="published" id="published" value="1" {{ $project->published || old('published', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="slug" id="slug" value="{{ old('slug', $project->slug) }}">
                            @if($errors->has('slug'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('slug') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="challenges" id="challenges">{!! old('challenges', $project->challenges) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="solutions" id="solutions">{!! old('solutions', $project->solutions) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="meta_title" id="meta_title" value="{{ old('meta_title', $project->meta_title) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="meta_description" id="meta_description" value="{{ old('meta_description', $project->meta_description) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="fb_title" id="fb_title" value="{{ old('fb_title', $project->fb_title) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="tw_title" id="tw_title" value="{{ old('tw_title', $project->tw_title) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="fb_description" id="fb_description" value="{{ old('fb_description', $project->fb_description) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="tw_description" id="tw_description" value="{{ old('tw_description', $project->tw_description) }}">
