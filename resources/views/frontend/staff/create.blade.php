    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.staff.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="short_intro" id="short_intro">{{ old('short_intro') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="other_link" id="other_link" value="{{ old('other_link', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="staff_email" id="staff_email" value="{{ old('staff_email') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="gravatar" id="gravatar" value="{{ old('gravatar') }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="in_teams" id="in_teams" value="1" {{ old('in_teams', 0) == 1 || old('in_teams') === null ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_author" id="is_author" value="1" {{ old('is_author', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="list_on_about" id="list_on_about" value="1" {{ old('list_on_about', 0) == 1 ? 'checked' : '' }}>
