    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.threads.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <label for="published">{{ trans('cruds.thread.fields.published') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <label for="closed">{{ trans('cruds.thread.fields.closed') }}</label>
                            </div>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('frontend.threads.storeCKEditorImages') }}', true);
...
<script>
    ...
    url: '{{ route('frontend.threads.storeMedia') }}',
    maxFilesize: 2, // MB
