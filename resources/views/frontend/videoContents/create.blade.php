    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.video-contents.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="public_everywhere" id="public_everywhere" value="1" {{ old('public_everywhere', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="alternate_title" id="alternate_title" value="{{ old('alternate_title', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="vimeo" id="vimeo" value="{{ old('vimeo', '') }}">
                            @if($errors->has('vimeo'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('vimeo') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="other_video" id="other_video" value="{{ old('other_video', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="fbt" id="fbt" value="{{ old('fbt', '') }}">
                            @if($errors->has('fbt'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('fbt') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="fbd" id="fbd" value="{{ old('fbd', '') }}">
                            @if($errors->has('fbd'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('fbd') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="twt" id="twt" value="{{ old('twt', '') }}">
                            @if($errors->has('twt'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('twt') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="twd" id="twd" value="{{ old('twd', '') }}">
                            @if($errors->has('twd'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('twd') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="notes_area" id="notes_area">{{ old('notes_area') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\VideoContent::VIDEO_TYPE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="video_type_{{ $key }}" name="video_type" value="{{ $key }}" {{ old('video_type', 'youtube') === (string) $key ? 'checked' : '' }}>
