                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('pagesection_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.pagesections.index') }}">
                                    ...
                                    @can('content_section_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.content-sections.index') }}">
                                    ...
                                    @endcan
                                    @can('thread_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.threads.index') }}">
                                    ...
                                    @can('video_content_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.video-contents.index') }}">
                                    ...
                                    @endcan
                                    @can('staff_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.staff.index') }}">
                                    ...
                                    @can('technology_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.technologies.index') }}">
